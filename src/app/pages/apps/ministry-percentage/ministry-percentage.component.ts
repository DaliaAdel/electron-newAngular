...
@Component({
  selector: 'app-ministry-percentage',
  standalone: true,
  imports: [
    MaterialModule,
    FormsModule,
  ...
  templateUrl: './ministry-percentage.component.html',
  styleUrl: './ministry-percentage.component.scss'
})
export class MinistryPercentageComponent {
  ...
  displayedColumns: string[] = ['#', 'name', 'percent', 'created_by', 'action'];
    ...
    return this.http.get<{ data: any[] }>(`${environment.apiUrl}/ministryPercentage`, { headers }).pipe(
      ...
      deleteInstallment_rates(element: PeriodicElement): void {
        ...
        const headers = {
          Authorization: `Bearer ${authToken}`,
            ...
            this.http.delete<{ data: any[] }>( `${environment.apiUrl}/ministryPercentage/${element.id}`,
    ...
    const headers = {
      Authorization: `Bearer ${authToken}`,
        ...
        this.http.put<{ data: any[] }>(
          `${environment.apiUrl}/ministryPercentage/${this.data.id}`,
        ...
        this.http.post<{ data: any[] }>(
          `${environment.apiUrl}/ministryPercentage`,
          formData, // formData as the request body
          { headers } // headers passed separately as the third argument
        ).subscribe(
          (response) => {
