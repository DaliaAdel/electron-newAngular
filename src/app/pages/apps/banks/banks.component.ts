...
export class BanksComponent {
  ...
  return this.http.get<{ data: any[] }>(`${environment.apiUrl}/banks`, { headers }).pipe(
  ...
  deleteElement(element: PeriodicElement): void {
    ...
    const headers = {
      ...
      //  const url ="https://electronkw.net/new_laravel_API/api/regions";
        ...
        this.http.delete<{ data: any[] }>( `${environment.apiUrl}/banks/${element.id}`,
    ...
    const headers = {
      Authorization: `Bearer ${authToken}`,
        ...
        this.http.put<{ data: any[] }>(
          `${environment.apiUrl}/banks/${this.data.id}`,
